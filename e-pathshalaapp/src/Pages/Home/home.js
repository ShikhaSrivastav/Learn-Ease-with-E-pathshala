...
const Home = () => {
  ...
  return (
   ...
   <head>
        ...
        <title>Learn Ease With E-Pathshala</title>
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Unlock Your Learning Potential with E-Pathshala</div>
                <div class="masthead-heading text-uppercase">Learn Ease With E-Pathshala</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="/Courses">Tell Me More</a>
            </div>
        </header>
        {/* <!-- Services--> */}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4"> 
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Spring/Spring Boot</div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Data Structure</div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">HTML/CSS</div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Reactjs</div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="team-member">
                            ...
                            <a class="btn btn-dark btn-social mx-2" href="https://github.com/ShikhaSrivastav" aria-label="Shikha Srivastava Github Profile"><i class="fab fa-github"></i></a>
                            {/* <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Shikha Srivastava Gmail Profile"><i class="fa-light fa-envelopes"></i></a> */}
                            <a class="btn btn-dark btn-social mx-2" href="https://www.linkedin.com/in/shikha-srivastava-378966216/" aria-label="Shikha Srivastava LinkedIn Profile"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/img/team/2.jpg" alt="..." />
                            <h4>Sakshi Godgirkar</h4>
                            <p class="text-muted">Developer</p>
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label=" Sakshi GodgirkarGithub Profile"><i class="fab fa-github"></i></a>
                            {/* <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Diana Petersen Facebook Profile"><i class="fa-light fa-envelopes"></i></a> */}
                            <a class="btn btn-dark btn-social mx-2" href="#!" aria-label="Sakshi Godgirkar LinkedIn Profile"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                    {/* <div class="col-lg-4">
                        <div class="team-member">
